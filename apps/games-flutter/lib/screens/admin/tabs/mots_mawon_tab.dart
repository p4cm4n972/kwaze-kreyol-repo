...
/// Onglet des statistiques du jeu Mots Mawon
class MotsMawonTab extends StatefulWidget {
  const MotsMawonTab({super.key});

  @override
  State<MotsMawonTab> createState() => _MotsMawonTabState();
}

class _MotsMawonTabState extends State<MotsMawonTab> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await Future.wait([
        _adminService.getMotsMawonStats(),
        _adminService.getMotsMawonOverTime(daysBack: 30),
        _adminService.getTopMotsMawonPlayers(limit: 10),
      ]);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              builder: (context, constraints) {
                ...
                return GridView.count(
                  ...
                  children: [
                    ...
                    StatCard(
                      title: 'Mots trouvés (moy)',
                      value: '${(_stats?.avgWordsFound ?? 0).toStringAsFixed(1)}',
            ...
            if (_topPlayers != null)
              TopPlayersList(
                title: 'Top 10 Joueurs Mots Mawon',
                players: _topPlayers!,
